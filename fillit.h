...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/04/02 14:48:13 by alaulom           #+#    #+#             */
/*   Updated: 2016/04/02 14:48:18 by alaulom          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_trimino				*fillit(char *file,
								char *buf,
								int *end,
								t_trimino *tetriminos);

t_trimino				*tetrimino_new(char *str,
										t_trimino *prev,
										int *end);
...
void					map_reset_tetriminos(t_map *map,
											t_trimino *tetriminos);
t_map					*map_new(void);
t_map					*map_dup(t_map *map);
void					map_view(t_map *map);
int						map_check_tetrimino(t_map *m, t_trimino *tet,
											int x, int y);
int						map_print_tetrimino(t_map *m, t_trimino *tet,
											int x, int y);
void					map_unprint_tetrimino(t_map *map,
												t_trimino *tetrimino);
